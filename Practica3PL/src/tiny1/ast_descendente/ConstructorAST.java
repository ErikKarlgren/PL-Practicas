...
public class ConstructorAST implements ConstructorASTConstants {
  ...
  final public ListaParams REParams() throws ParseException {
    ...
    case identificador:
      lp = ListaParams();
      jj_consume_token(49);
                                                         {if (true) return sem.params_con(lp);}
      break;
    case 49:
      jj_consume_token(49);
  ...
  final public Instruccion Instruccion() throws ParseException {
                                      Expresion e1,e2; InstruccionesOpt instrsOpt; Instruccion inst; Token t; ParamsReal params;Bloque bloque;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case numeroEntero:
    case numeroReal:
    case True:
  ...
  final public ParamsReal ParamReal() throws ParseException {
                                     ParamsReal params;
    jj_consume_token(48);
    params = REParamReal();
  ...
  final public ParamsReal REParamReal() throws ParseException {
                                     Expresiones e;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case 49:
      jj_consume_token(49);
                                        {if (true) return sem.params_real_ninguna();}
      break;
    case numeroEntero:
    case numeroReal:
    case True:
    ...
    case 59:
      e = Expresiones();
      jj_consume_token(49);
                                                         {if (true) return sem.params_real_muchas(e);}
      break;
    default:
      jj_la1[12] = jj_gen;
      jj_consume_token(-1);
  ...
  final public Expresion ExpresionBasica() throws ParseException {
    ...
    case True:
      t = jj_consume_token(True);
                                             {if (true) return sem.true_(sem.str(t.image,t.beginLine,t.beginColumn));}
      break;
    case False:
      t = jj_consume_token(False);
                                              {if (true) return sem.false_(sem.str(t.image,t.beginLine,t.beginColumn));}
      break;
    case Null:
      t = jj_consume_token(Null);
                                             {if (true) return sem.nulo(sem.str(t.image,t.beginLine,t.beginColumn));}
      break;
    case cadena:
