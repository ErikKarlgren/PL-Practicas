...
/** CUP v0.11b beta 20140220 generated parser.
  * @version Sun May 08 14:30:37 CEST 2022
  */
  ...
  public final java_cup.runtime.Symbol CUP$ConstructorAST$do_action_part00000000(
    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP$ConstructorAST$act_num)
		...
		Instrucciones instrs = (Instrucciones)((java_cup.runtime.Symbol) CUP$ConstructorAST$stack.peek()).value;
		...
		StringLocalizado id = (StringLocalizado)((java_cup.runtime.Symbol) CUP$ConstructorAST$stack.peek()).value;
		 RESULT = sem.dec_var(tipo, id); 
              CUP$ConstructorAST$result = parser.getSymbolFactory().newSymbol("Declaracion",3, RESULT);
            }
          return CUP$ConstructorAST$result;
		...
		ListaParams params = (ListaParams)((java_cup.runtime.Symbol) CUP$ConstructorAST$stack.elementAt(CUP$ConstructorAST$top-1)).value;
		...
		ListaParams lp = (ListaParams)((java_cup.runtime.Symbol) CUP$ConstructorAST$stack.elementAt(CUP$ConstructorAST$top-1)).value;
		 RESULT = lp; 
              CUP$ConstructorAST$result = parser.getSymbolFactory().newSymbol("Params",5, RESULT);
            }
          return CUP$ConstructorAST$result;
		 ...
		 RESULT = sem.params_sin(); 
          ...
          case 10: // ListaParams ::= ListaParams COMA Param 
            {
              ListaParams RESULT =null;
		ListaParams lp = (ListaParams)((java_cup.runtime.Symbol) CUP$ConstructorAST$stack.elementAt(CUP$ConstructorAST$top-2)).value;
		Parametro p = (Parametro)((java_cup.runtime.Symbol) CUP$ConstructorAST$stack.peek()).value;
		 RESULT = sem.lista_params_muchos(lp, p); 
              CUP$ConstructorAST$result = parser.getSymbolFactory().newSymbol("ListaParams",4, RESULT);
            }
          return CUP$ConstructorAST$result;
          ...
          case 14: // Tipo ::= INT 
            {
              Tipo RESULT =null;
		 RESULT = sem.int_(); 
              CUP$ConstructorAST$result = parser.getSymbolFactory().newSymbol("Tipo",7, RESULT);
            }
          return CUP$ConstructorAST$result;
		...
		Campos campos = (Campos)((java_cup.runtime.Symbol) CUP$ConstructorAST$stack.elementAt(CUP$ConstructorAST$top-1)).value;
		 RESULT = sem.tipo_record(campos); 
          ...
          case 22: // Campos ::= Campos PCOMA Campo 
            {
              Campos RESULT =null;
		Campos cs = (Campos)((java_cup.runtime.Symbol) CUP$ConstructorAST$stack.elementAt(CUP$ConstructorAST$top-2)).value;
		Campo c = (Campo)((java_cup.runtime.Symbol) CUP$ConstructorAST$stack.peek()).value;
		 RESULT = sem.campos_muchos(cs, c); 
              CUP$ConstructorAST$result = parser.getSymbolFactory().newSymbol("Campos",8, RESULT);
            }
          return CUP$ConstructorAST$result;
		...
		StringLocalizado id = (StringLocalizado)((java_cup.runtime.Symbol) CUP$ConstructorAST$stack.peek()).value;
		 RESULT = sem.campo(tipo, id); 
              CUP$ConstructorAST$result = parser.getSymbolFactory().newSymbol("Campo",9, RESULT);
            }
          return CUP$ConstructorAST$result;
		...
		Instrucciones instrs = (Instrucciones)((java_cup.runtime.Symbol) CUP$ConstructorAST$stack.elementAt(CUP$ConstructorAST$top-2)).value;
		Instruccion instr = (Instruccion)((java_cup.runtime.Symbol) CUP$ConstructorAST$stack.peek()).value;
		 RESULT = sem.instr_muchas(instrs, instr); 
              CUP$ConstructorAST$result = parser.getSymbolFactory().newSymbol("Instrucciones",2, RESULT);
            }
          return CUP$ConstructorAST$result;
		...
		Expresion e1 = (Expresion)((java_cup.runtime.Symbol) CUP$ConstructorAST$stack.elementAt(CUP$ConstructorAST$top-2)).value;
		Expresion e2 = (Expresion)((java_cup.runtime.Symbol) CUP$ConstructorAST$stack.peek()).value;
		 RESULT = sem.instr_asig(e1, e2); 
              CUP$ConstructorAST$result = parser.getSymbolFactory().newSymbol("Instruccion",10, RESULT);
            }
          return CUP$ConstructorAST$result;
		...
		Instrucciones instrs = (Instrucciones)((java_cup.runtime.Symbol) CUP$ConstructorAST$stack.peek()).value;
		 RESULT = sem.instr_opt_muchas(instrs); 
              CUP$ConstructorAST$result = parser.getSymbolFactory().newSymbol("InstruccionesOpt",11, RESULT);
            }
          return CUP$ConstructorAST$result;
		 ...
		 RESULT = sem.instr_opt_ninguna(); 
          ...
          case 30: // Instruccion ::= IF Expresion THEN InstruccionesOpt ENDIF 
            {
              Instruccion RESULT =null;
		Expresion exp = (Expresion)((java_cup.runtime.Symbol) CUP$ConstructorAST$stack.elementAt(CUP$ConstructorAST$top-3)).value;
		InstruccionesOpt ins = (InstruccionesOpt)((java_cup.runtime.Symbol) CUP$ConstructorAST$stack.elementAt(CUP$ConstructorAST$top-1)).value;
		 RESULT = sem.instr_if(exp, ins); 
          ...
          case 31: // Instruccion ::= IF Expresion THEN InstruccionesOpt ELSE InstruccionesOpt ENDIF 
            {
              Instruccion RESULT =null;
		Expresion exp = (Expresion)((java_cup.runtime.Symbol) CUP$ConstructorAST$stack.elementAt(CUP$ConstructorAST$top-5)).value;
		InstruccionesOpt ins1 = (InstruccionesOpt)((java_cup.runtime.Symbol) CUP$ConstructorAST$stack.elementAt(CUP$ConstructorAST$top-3)).value;
		InstruccionesOpt ins2 = (InstruccionesOpt)((java_cup.runtime.Symbol) CUP$ConstructorAST$stack.elementAt(CUP$ConstructorAST$top-1)).value;
		...
		InstruccionesOpt ins = (InstruccionesOpt)((java_cup.runtime.Symbol) CUP$ConstructorAST$stack.elementAt(CUP$ConstructorAST$top-1)).value;
		 RESULT = sem.instr_while(exp, ins); 
          ...
          case 33: // Instruccion ::= READ Expresion 
            {
              Instruccion RESULT =null;
		Expresion exp = (Expresion)((java_cup.runtime.Symbol) CUP$ConstructorAST$stack.peek()).value;
		...
		Expresiones params = (Expresiones)((java_cup.runtime.Symbol) CUP$ConstructorAST$stack.peek()).value;
		...
		Bloque bloque = (Bloque)((java_cup.runtime.Symbol) CUP$ConstructorAST$stack.peek()).value;
		 ...
		 RESULT = sem.expresiones_ninguna(); 
              CUP$ConstructorAST$result = parser.getSymbolFactory().newSymbol("ParamsReal",23, RESULT);
            }
          return CUP$ConstructorAST$result;
          ...
          case 41: // ParamsReal ::= PAPERTURA Expresiones PCIERRE 
            {
              Expresiones RESULT =null;
		Expresiones exps = (Expresiones)((java_cup.runtime.Symbol) CUP$ConstructorAST$stack.elementAt(CUP$ConstructorAST$top-1)).value;
		 RESULT = exps; 
              CUP$ConstructorAST$result = parser.getSymbolFactory().newSymbol("ParamsReal",23, RESULT);
            }
          return CUP$ConstructorAST$result;
          ...
          case 42: // Expresiones ::= Expresiones COMA Expresion 
            {
              Expresiones RESULT =null;
		Expresiones exps = (Expresiones)((java_cup.runtime.Symbol) CUP$ConstructorAST$stack.elementAt(CUP$ConstructorAST$top-2)).value;
		Expresion exp = (Expresion)((java_cup.runtime.Symbol) CUP$ConstructorAST$stack.peek()).value;
		 RESULT = sem.expresiones_muchas(exps, exp); 
              CUP$ConstructorAST$result = parser.getSymbolFactory().newSymbol("Expresiones",22, RESULT);
            }
          return CUP$ConstructorAST$result;
		...
		Expresion exp = (Expresion)((java_cup.runtime.Symbol) CUP$ConstructorAST$stack.peek()).value;
		 RESULT = sem.expresiones_una(exp); 
          ...
          case 44: // Bloque ::= LLAVE_APERTURA Programa LLAVE_CIERRE 
            {
              Bloque RESULT =null;
		Programa prog = (Programa)((java_cup.runtime.Symbol) CUP$ConstructorAST$stack.elementAt(CUP$ConstructorAST$top-1)).value;
		 RESULT = sem.bloque_lleno(prog); 
              CUP$ConstructorAST$result = parser.getSymbolFactory().newSymbol("Bloque",24, RESULT);
            }
          return CUP$ConstructorAST$result;
		...
		Expresion exp = (Expresion)((java_cup.runtime.Symbol) CUP$ConstructorAST$stack.peek()).value;
		 RESULT = exp; 
              CUP$ConstructorAST$result = parser.getSymbolFactory().newSymbol("Expresion",12, RESULT);
            }
          return CUP$ConstructorAST$result;
		...
		StringLocalizado num = (StringLocalizado)((java_cup.runtime.Symbol) CUP$ConstructorAST$stack.peek()).value;
		 RESULT = sem.num_entero(num); 
              CUP$ConstructorAST$result = parser.getSymbolFactory().newSymbol("ExpresionBasica",13, RESULT);
            }
          return CUP$ConstructorAST$result;
		...
		Expresion e2 = (Expresion)((java_cup.runtime.Symbol) CUP$ConstructorAST$stack.peek()).value;
		 RESULT = sem.suma(e1, e2); 
              CUP$ConstructorAST$result = parser.getSymbolFactory().newSymbol("E0",14, RESULT);
            }
          return CUP$ConstructorAST$result;
		...
		Expresion e2 = (Expresion)((java_cup.runtime.Symbol) CUP$ConstructorAST$stack.peek()).value;
		 RESULT = sem.resta(e1, e2); 
          ...
          case 56: // E0 ::= E1 
            {
              Expresion RESULT =null;
		Expresion e = (Expresion)((java_cup.runtime.Symbol) CUP$ConstructorAST$stack.peek()).value;
		 RESULT = e; 
              CUP$ConstructorAST$result = parser.getSymbolFactory().newSymbol("E0",14, RESULT);
            }
          return CUP$ConstructorAST$result;
		...
		Expresion e2 = (Expresion)((java_cup.runtime.Symbol) CUP$ConstructorAST$stack.peek()).value;
		 RESULT = sem.exp(op, e1, e2); 
              CUP$ConstructorAST$result = parser.getSymbolFactory().newSymbol("E1",15, RESULT);
            }
          return CUP$ConstructorAST$result;
		...
		Expresion e2 = (Expresion)((java_cup.runtime.Symbol) CUP$ConstructorAST$stack.peek()).value;
		 RESULT = sem.exp(op, e1, e2); 
              CUP$ConstructorAST$result = parser.getSymbolFactory().newSymbol("E2",16, RESULT);
            }
          return CUP$ConstructorAST$result;
		...
		Expresion e2 = (Expresion)((java_cup.runtime.Symbol) CUP$ConstructorAST$stack.peek()).value;
		 RESULT = sem.exp(op, e1, e2); 
              CUP$ConstructorAST$result = parser.getSymbolFactory().newSymbol("E3",17, RESULT);
            }
          return CUP$ConstructorAST$result;
		...
		Expresion e = (Expresion)((java_cup.runtime.Symbol) CUP$ConstructorAST$stack.peek()).value;
		 RESULT = sem.not(e); 
              CUP$ConstructorAST$result = parser.getSymbolFactory().newSymbol("E4",18, RESULT);
            }
          return CUP$ConstructorAST$result;
		...
		Expresion e = (Expresion)((java_cup.runtime.Symbol) CUP$ConstructorAST$stack.peek()).value;
		 RESULT = e; 
          ...
          case 66: // E5 ::= E5 CORAPERTURA Expresion CORCIERRE 
            {
              Expresion RESULT =null;
		Expresion e1 = (Expresion)((java_cup.runtime.Symbol) CUP$ConstructorAST$stack.elementAt(CUP$ConstructorAST$top-3)).value;
		Expresion e2 = (Expresion)((java_cup.runtime.Symbol) CUP$ConstructorAST$stack.elementAt(CUP$ConstructorAST$top-1)).value;
		 RESULT = sem.acceso_array(e1, e2); 
              CUP$ConstructorAST$result = parser.getSymbolFactory().newSymbol("E5",19, RESULT);
            }
          return CUP$ConstructorAST$result;
          ...
          case 67: // E5 ::= E5 OP5 VARIABLE 
            {
              Expresion RESULT =null;
		Expresion e = (Expresion)((java_cup.runtime.Symbol) CUP$ConstructorAST$stack.elementAt(CUP$ConstructorAST$top-2)).value;
		String op = (String)((java_cup.runtime.Symbol) CUP$ConstructorAST$stack.elementAt(CUP$ConstructorAST$top-1)).value;
		StringLocalizado id = (StringLocalizado)((java_cup.runtime.Symbol) CUP$ConstructorAST$stack.peek()).value;
		...
		Expresion e = (Expresion)((java_cup.runtime.Symbol) CUP$ConstructorAST$stack.peek()).value;
		 RESULT = sem.valor_puntero(e); 
              CUP$ConstructorAST$result = parser.getSymbolFactory().newSymbol("E6",20, RESULT);
            }
          return CUP$ConstructorAST$result;
		...
		Expresion e = (Expresion)((java_cup.runtime.Symbol) CUP$ConstructorAST$stack.peek()).value;
		 RESULT = e; 
          ...
          case 71: // E7 ::= PAPERTURA Expresion PCIERRE 
            {
              Expresion RESULT =null;
		Expresion e = (Expresion)((java_cup.runtime.Symbol) CUP$ConstructorAST$stack.elementAt(CUP$ConstructorAST$top-1)).value;
		 RESULT = e; 
              CUP$ConstructorAST$result = parser.getSymbolFactory().newSymbol("E7",21, RESULT);
            }
          return CUP$ConstructorAST$result;
          ...
          case 73: // OP1 ::= AND 
            {
              String RESULT =null;
		 RESULT = "and"; 
              CUP$ConstructorAST$result = parser.getSymbolFactory().newSymbol("OP1",25, RESULT);
            }
          return CUP$ConstructorAST$result;
          ...
          case 75: // OP2 ::= MAYOR 
            {
              String RESULT =null;
		 RESULT = ">"; 
              CUP$ConstructorAST$result = parser.getSymbolFactory().newSymbol("OP2",26, RESULT);
            }
          return CUP$ConstructorAST$result;
          ...
          case 81: // OP3 ::= POR 
            {
              String RESULT =null;
		 RESULT = "*"; 
              CUP$ConstructorAST$result = parser.getSymbolFactory().newSymbol("OP3",27, RESULT);
            }
          return CUP$ConstructorAST$result;
          ...
          case 84: // OP5 ::= PUNTO 
            {
              String RESULT =null;
		 RESULT = "."; 
              CUP$ConstructorAST$result = parser.getSymbolFactory().newSymbol("OP5",28, RESULT);
            }
          return CUP$ConstructorAST$result;
